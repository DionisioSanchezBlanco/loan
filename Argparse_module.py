...
# Object wich will store all the information about arguments
# "Description" is an explanation about your progrm
parser = argparse.ArgumentParser(description="This program prints recipes \
    consisting of the ingredients you provide")

# Adding arguments
# Parameter choices
# Help contains a short description of an argument
